    ...
    */
    public long testLocationTable() {
        ...
        // Insert ContentValues into database and get a row ID back
            long locRowId;
        locRowId = db.insert(WeatherContract.LocationEntry.TABLE_NAME,null,cv);
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("error",cursor,cv);
        assertFalse("error1",cursor.moveToFirst());
        cursor.close();
        db.close();
        return locRowId;
